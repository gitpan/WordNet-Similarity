...
relatedness. The following strings are defined.
  ...
  WordNet::Similarity::path         Simple node-counts (inverted).
  WordNet::Similarity::wup          The Wu Palmer measure.
  ...
  WordNet::Similarity::lesk         Extended gloss overlap measure.
  WordNet::Similarity::vector       Gloss Vector measure.
  WordNet::Similarity::vector_pairs Gloss Vector measure (pairwise).
  WordNet::Similarity::random       A random-number "measure".
...
different corpora of text available. 
  ...
  semCorFreq.pl     -- from SemCor X.X (using the sense tags). 
  semCorRawFreq.pl  -- from SemCor X.X (ignoring the sense tags). 
...
<utility> [{--compfile COMPFILE --outfile OUTFILE 
...
Used to specify the file COMPFILE containing the
...
the command:
 ...
 BNCFreq.pl --compfile ../samples/compounds.dat --outfile infoBNC.dat /home/sid/BNC-world/Texts
...
will be provided in future releases of this software.
 ...
 Usage: wordVectors.pl [{ [--compfile COMPOUNDS] [--stopfile STOPLIST]
