...
Instructions on how to write a new measure.
...
If you want to find LCSs (Least Common Subsumers), the
WordNet::Similarity::LCSFinder module has useful methods:
...
L<intro.pod> L<config.pod> L<modules.pod>

=head1 COPYRIGHT AND LICENSE

Copyright (C) 2003 Siddharth Patwardhan, Ted Pedersen, and Jason Michelizzi
