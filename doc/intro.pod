# run perldoc on this file to get nicely formatted documenation
...
St-Onge (1998), Wu & Palmer (1994), the adapted gloss overlap measure by 
...
lesk.pm, vector.pm, wup.pm, path.pm and random.pm -- present in the 
/lib/WordNet/Similarity subdirectory and the supporting modules
get_wn_info.pm and string_compare.pm. There also exists a 
...
Bano (Satanjeev Banerjee) for his work on the adapted gloss overlap module.
...
L<http://search.cpan.org/dist/WordNet-Similarity>,
